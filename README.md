...
> Static code review for your Gerrit and Stash patchsets. Runs Checkstyle, PMD, FindBugs, Scalastyle, CodeNarc, JSLint, scss-lint and Sonar for you!
...
Sputnik runs Checkstyle, PMD, FindBugs, CodeNarc, JSHint (or JSLint), scss-lint and Sonar only on files affected by Gerrit's patchset. It collects all violations and report them back to Gerrit or Stash.
...
scsslint.enabled=true
scsslint.configurationFile=scss-config.yml
sonar.enabled=true
