...
import pl.touk.sputnik.processor.scsslint.ScssLintProcessor;
...
public class ProcessorBuilder {
    ...
    public List<ReviewProcessor> buildProcessors() {
        ...
        if (Boolean.valueOf(ConfigurationHolder.instance().getProperty(GeneralOption.SCSSLINT_ENABLED))) {
            processors.add(new ScssLintProcessor());
        }
